...
- เปิดดูตัวเลขสรุปและกราฟบน Dashboard ได้โดยไม่ต้องเข้าสู่ระบบ โดยไม่เปิดเผยข้อมูลผู้ป่วย
...
- ชุดข้อมูลตัวอย่าง 78 เคสที่ครอบคลุมหลายกลไก ระดับ triage และช่วงการรักษา พร้อมปุ่มลบเฉพาะข้อมูลตัวอย่าง
...
ในหน้า **Settings > Backup / Restore** สามารถเพิ่มหรือรีเซ็ตข้อมูลตัวอย่าง 78 เคส และลบเฉพาะเคสที่ขึ้นต้นด้วย `TR-SAMPLE-` ได้โดยไม่กระทบเคสจริง
