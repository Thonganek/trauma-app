...
- เมนูประเมิน ALS และ BLS ตามแบบบันทึกต้นฉบับ ครบ 6 หมวด พร้อมคำนวณเวลาและระยะทางอัตโนมัติ
...
โปรเจกต์ที่ติดตั้งสคีมาเดิมอยู่แล้วให้รัน `supabase/ems-assessments.sql` เพิ่มหนึ่งครั้ง เพื่อสร้างตารางแบบประเมิน ALS/BLS โดยข้อมูลทั้งสองแบบเชื่อมกับ Trauma Case และถูกลบตามอัตโนมัติเมื่อเคสนั้นถูกลบ
